    ...
    return (
        ...
        <div className="w-10/12 rounded overflow-hidden shadow-lg p-4 m-5 bg-white flex-col text-black justify-center">
            ...
            <div className="flex flex-col lg:flex-row justify-items-center">
                ...
                <img className="mx-auto w-80 lg:w-1/3 xl:w-1/4" src={product.thumbnail} alt="Picture of product"/>

                <div className="basis-1/2 flex flex-col justify-between text-center">
                    <span className="my-3">{product.description}</span>
                    <span className="my-3 lg:my-0">Category : {product.category}</span>
                    ...
                    <div className="my-3 lg:my-0 flex justify-around">
        ...
        <div className="w-10/12 rounded overflow-hidden shadow-lg p-4 m-5 bg-white  text-black justify-center ">
                <h2 className="text-2xl my-4 text-center">Reviews</h2>
                {product.reviews.length === 0 ? (
                    <p className="text-gray-500">Aucun avis pour ce produit.</p>
                ) : (
                    <ul className="space-y-4 w-auto flex flex-col lg:flex-row justify-around	">
